...
import com.youwonn_invest.common.ImageLoaderEx;
import com.youwonn_invest.constant.URLS;
import com.youwonn_invest.model.LiveRoomModel;
import com.youwonn_invest.utils.ExampleUtil;
...
public class BaseApplication extends Application {
    ...
    public void onCreate() {
        ...
        org.xutils.x.Ext.setDebug(false); //是否输出debug日子,开启会影响性能
    ...
    /**
     * 应用启动向服务器发送jpush的registerID
     */
    private void sentRegId() {
        RequestParams params = new RequestParams(URLS.ADD_USER_DEVICE);
        params.addBodyParameter("regid", JPushInterface.getRegistrationID(this));
        params.addBodyParameter("token", PrefUtils.getString(getApplicationContext(), "USER_TOKEN", ""));
//        UIHelper.toastMessage(getApplicationContext(),PrefUtils.getString(getApplicationContext(),"USER_TOKEN",""));
        Log.e("-------regid", "" + JPushInterface.getRegistrationID(this));
