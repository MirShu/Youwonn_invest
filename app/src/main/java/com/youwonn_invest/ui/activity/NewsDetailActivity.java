...
import com.youwonn_invest.common.SysStatusCode;
...
public class NewsDetailActivity extends Activity implements View.OnClickListener {
    ...
    private ScrollView ll_view_main;
    ...
    public void initView() {
        ...
        this.ll_view_main = (ScrollView) findViewById(R.id.ll_view_main);
        ...
        this.fl_background.bringToFront();
    ...
    public void fillView() {
        if (!NetUtil.isNetworkConnected(NewsDetailActivity.this)) {
    ...
    private void bindRecycleView() {
        this.rvRelatedAdapter = new RecyclerAdapter<NewsModel>(this, listNewsRelevant, R.layout.itme_related) {
            @Override
            public void convert(RecyclerViewHolder helper, NewsModel item, int position) {
                ...
                TextView news_title = helper.getView(R.id.news_title);
                SharedPreferences sp = getSharedPreferences("user_info", MODE_PRIVATE);
                String nightCheck = sp.getString("NIGHT_CHECK", "");
                if (nightCheck.equals("2")) {
                    news_title.setTextColor(0xffacacac);
                }
            }
        };
    ...
    private void webView() {
        sharedToken = this.getSharedPreferences("user_info", MODE_PRIVATE);
        token = sharedToken.getString("USER_TOKEN", "");
        RequestParams params = new RequestParams(URLS.NEWS_NEWSINFO);
        params.addBodyParameter("tips", String.valueOf(newsTips));
